...
begin
		...
		*/
		...
		--Pages
		Insert Into [dbo].[Pages]([Id],[Name],[ActionName],[ControlName],[Area],[ShowPage],[ActiveFlag],[DateAdded],[DateUpdated],[AddedBy],[UpdatedBy]) values('44A65941-0468-4A16-8057-826ED97C0610',N'财务管理',N'Index','MoneyCtrl','Admin','true',1,GETDATE(),GETDATE(),'40D76804-597C-450F-96DA-814BC4CBAF3D','40D76804-597C-450F-96DA-814BC4CBAF3D')
		Insert Into [dbo].[Pages]([Id],[Name],[ActionName],[ControlName],[Area],[ShowPage],[ActiveFlag],[DateAdded],[DateUpdated],[AddedBy],[UpdatedBy]) values('A4641751-CCE0-42E0-A033-3ADDEE571E1B',N'修改财务',N'Edit','MoneyCtrl','Admin','true',1,GETDATE(),GETDATE(),'40D76804-597C-450F-96DA-814BC4CBAF3D','40D76804-597C-450F-96DA-814BC4CBAF3D')
		Insert Into [dbo].[Pages]([Id],[Name],[ActionName],[ControlName],[Area],[ShowPage],[ActiveFlag],[DateAdded],[DateUpdated],[AddedBy],[UpdatedBy]) values('DB2A9DFB-6DA9-44EF-9F38-D76F6D1E6B2D',N'添加财务',N'Add','MoneyCtrl','Admin','true',1,GETDATE(),GETDATE(),'40D76804-597C-450F-96DA-814BC4CBAF3D','40D76804-597C-450F-96DA-814BC4CBAF3D')
		Insert Into [dbo].[Pages]([Id],[Name],[ActionName],[ControlName],[Area],[ShowPage],[ActiveFlag],[DateAdded],[DateUpdated],[AddedBy],[UpdatedBy]) values('C726DDBD-FDBF-4CA1-9FC9-E8801FFA0610',N'修改管理员',N'Edit','Member','Admin','true',1,GETDATE(),GETDATE(),'40D76804-597C-450F-96DA-814BC4CBAF3D','40D76804-597C-450F-96DA-814BC4CBAF3D')
		Insert Into [dbo].[Pages]([Id],[Name],[ActionName],[ControlName],[Area],[ShowPage],[ActiveFlag],[DateAdded],[DateUpdated],[AddedBy],[UpdatedBy]) values('C5EE444C-62ED-4DF9-AF39-36966DAA0526',N'管理员管理',N'Index','Member','Admin','true',1,GETDATE(),GETDATE(),'40D76804-597C-450F-96DA-814BC4CBAF3D','40D76804-597C-450F-96DA-814BC4CBAF3D')
		Insert Into [dbo].[Pages]([Id],[Name],[ActionName],[ControlName],[Area],[ShowPage],[ActiveFlag],[DateAdded],[DateUpdated],[AddedBy],[UpdatedBy]) values('E00F7137-DC2B-4161-9AC7-A7212471DD9D',N'添加管理员',N'Add','Member','Admin','true',1,GETDATE(),GETDATE(),'40D76804-597C-450F-96DA-814BC4CBAF3D','40D76804-597C-450F-96DA-814BC4CBAF3D')
